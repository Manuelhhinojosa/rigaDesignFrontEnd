...
export const textSlice = createSlice({
  ...
  initialState: {
    homeTitle: "RIGA",
    homeText:
      "Riga is an intimate extension of my artistic practice, an intersection between emotional geography and the objects that inhabit the everyday. This project was born from the need to translate the experience of the world—its colors, textures, and silences—into forms that can be carried, touched, and treasured. In these pieces, I explore how space shapes perception, how objects preserve memory, and how the body becomes a moving archive. Riga responds to the desire to materialize these explorations into forms that accompany the everyday: pieces that, beyond being used, engage in a dialogue with those who wear or observe them. Riga is born from the act of walking through cities, collecting impressions, atmospheres, and textures, and then transforming them into portable fragments of the world.",
    aboutText:
